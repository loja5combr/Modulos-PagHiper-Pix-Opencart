...
<a href="index.php?route=extension/payment/paghiperpix/pedidos&token=<?php echo $token;?>&page=<?php echo $pagina;?>&status=<?php echo $k;?>&tag=<?php echo $tag;?>" class="btn btn-default btn-xs<?php echo ($status==$k)?' active':'';?>"><?php echo $v;?></a>
<?php } ?>
</div>
</div>
